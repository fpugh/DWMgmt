USE [DWMgmt]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[CAT].[RPT_0334_Relational_Integrity]') AND type in (N'P', N'PC'))
DROP PROCEDURE [CAT].[RPT_0334_Relational_Integrity]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[CAT].[RPT_0334_Relational_Integrity]') AND type in (N'P', N'PC'))
BEGIN
