...
SELECT ocs.LNK_FK_T3_ID, ocs.LNK_FK_0300_ID, ocs.LNK_FK_0600_ID, ocs.LNK_Rank, ocl.REG_Code_Content, 1 as Critical_Priority
FROM CAT.LNK_0300_0600_Object_Code_Sections AS ocs WITH(NOLOCK)
JOIN CAT.REG_0600_Object_Code_Library AS ocl WITH(NOLOCK)
ON ocs.LNK_FK_0600_ID = ocl.REG_0600_ID
JOIN Wheres AS cte
...
JOIN CAT.VI_0354_Object_Data_Profile AS odp
