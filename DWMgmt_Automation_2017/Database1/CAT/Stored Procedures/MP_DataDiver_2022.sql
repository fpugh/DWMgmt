...
---	ToDo:																						---
---																								---
---	Try adding a full text index to the views containing Fully_Qualified_Name, and 				---
---	Schema_Bound_Name. This will allow faster multi-value queries using CONTAINS commands.		---
---------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------
