...
CREATE VIEW CAT.VH_0363_Code_Column_Reference
AS
...
AS (
	...
	, LNK_FK_0300_ID
	, LNK_FK_0400_ID
	FROM CAT.VH_0300_Full_Object_Map AS map WITH(NOLOCK)
	JOIN CAT.VH_0330_Object_Dependencies AS vod WITH(NOLOCK)
...
JOIN CAT.VH_0300_Full_Object_Map AS map WITH(NOLOCK)
