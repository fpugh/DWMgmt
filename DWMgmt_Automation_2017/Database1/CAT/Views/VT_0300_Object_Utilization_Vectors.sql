...
SELECT DENSE_RANK() OVER(ORDER BY lsd.LNK_T2_ID, lsb.LNK_T3_ID, oum.TRK_Last_Action_Type, ma1.TRK_Last_Action_Date) AS VID
...
, CAST(ma1.TRK_Last_Action_Date - ISNULL(crap.TRK_Last_Action_Date, ma1.TRK_Last_Action_Date) AS TIME) AS Diff_Last_Scan
