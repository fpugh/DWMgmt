USE [DWMgmt]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[CAT].[MP_003_CENTRAL_REGISTRY_PROCESS]') AND type in (N'P', N'PC'))
DROP PROCEDURE [CAT].[MP_003_CENTRAL_REGISTRY_PROCESS]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[CAT].[MP_003_CENTRAL_REGISTRY_PROCESS]') AND type in (N'P', N'PC'))
BEGIN
...
SET @SQL1 = ''
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0100_Server_Registry(REG_Server_Name, REG_Product, REG_Create_Date)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0101_Linked_Server_Settings (REG_Linked_Flag, REG_Remote_Login_Flag, REG_RPC_Out_Flag
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0102_Publication_Replication_Server_Settings (REG_Lazy_Schema_Flag
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0103_Server_Providers (REG_Provider, REG_data_source, REG_Provider_string, REG_catalog)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0200_Database_Registry (REG_Database_Name, REG_Compatibility
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0201_Database_Extended_Properties_A (page_verify_option
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0202_Database_Extended_Properties_B (Is_recursive_triggers_on
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0203_Database_Files (REG_File_ID, REG_File_Type
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0204_Database_Schemas (REG_Schema_Name)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0300_Object_Registry (REG_Object_Name, REG_Object_Type, REG_Create_Date)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0300_Object_Registry (REG_Object_Name, REG_Object_Type)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0301_Index_Details (Is_Unique
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0302_Foreign_Key_Details (Is_ms_Shipped, Is_Published
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0302_Foreign_Key_Details (Is_ms_Shipped, Is_Published, Is_Schema_Published, Is_System_Named, Key_Index_ID)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0400_Column_Registry (REG_Column_Name, REG_Column_Type)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0401_Column_Properties (REG_Size
...
INSERT INTO [''+@SourceDBLocation+''].CAT.REG_0402_Column_Index_Details (Index_Column_ID, Partition_Ordinal, Is_Descending_Key, Is_Included_Column)
...
INSERT INTO [''+@SourceDBLocation+''].TMP.Database_Latch_Insert (LNK_T2_ID, REG_0100_ID, REG_0200_ID, LNK_db_Rank, REG_0201_ID, REG_0202_ID, REG_0203_ID, REG_0204_ID)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.LNK_0100_0200_Server_Databases (LNK_FK_0100_ID, LNK_FK_0200_ID, LNK_db_Rank)
...
INSERT INTO [''+@SourceDBLocation+''].TMP.Object_Latch_Insert (LNK_T2_ID, LNK_T3_ID, REG_0204_ID, REG_0300_ID)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.LNK_0204_0300_Schema_Binding (LNK_FK_T2_ID, LNK_FK_0204_ID, LNK_FK_0300_ID)
...
INSERT INTO [''+@SourceDBLocation+''].TMP.Column_Latch_Insert (LNK_T2_ID, LNK_T3_ID, LNK_T4_ID, REG_0300_ID, REG_0400_ID, T4_Rank)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.LNK_0300_0400_Object_Column_Collection 
...
INSERT INTO [''+@SourceDBLocation+''].CAT.LNK_0300_0300_Object_Dependencies (LNK_FK_T3P_ID, LNK_FK_T3R_ID
...
INSERT INTO [''+@SourceDBLocation+''].CAT.LNK_Tier1_Peers (LNK_FK_0100_ID, LNK_FK_0101_ID, LNK_FK_0102_ID, LNK_FK_0103_ID)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.LNK_Tier3_Peers (LNK_FK_T3_ID, LNK_FK_0300_ID, LNK_FK_0301_ID, LNK_FK_0302_FK_ID, LNK_FK_0302_CD_ID)
...
INSERT INTO [''+@SourceDBLocation+''].CAT.LNK_Tier4_Peers (LNK_FK_T4_ID, LNK_FK_0400_ID, LNK_FK_0401_ID, LNK_FK_0402_ID)
...
SELECT DISTINCT tmp.LNK_T2_ID, tmp.LNK_T3_ID, trk.TRK_Last_Action_Type, trk.TRK_Last_Action_Date
, trk.Total_Seeks, trk.Total_Scans, trk.Total_Lookups, trk.Total_Updates
FROM [''+@SourceDBLocation+''].TMP.TRK_0300_Utiliztion_Insert AS trk
JOIN [''+@SourceDBLocation+''].TMP.REG_0204_0300_Insert AS tmp
ON trk.Object_ID = tmp.Object_ID
AND trk.Database_ID = tmp.Database_ID
AND trk.Server_ID = tmp.Server_ID
''
